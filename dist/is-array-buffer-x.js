...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return isArrayBuffer; });
...
if (hasABuf) {
  if (has_to_string_tag_x_esm) {
    ...
    if (is_array_buffer_x_esm_descriptor && typeof is_array_buffer_x_esm_descriptor.get === 'function') {
      var is_array_buffer_x_esm_res = attempt(function () {
      ...
      if (is_array_buffer_x_esm_res.threw === false && isObjectLike(is_array_buffer_x_esm_res.value)) {
        is_array_buffer_x_esm_res = attempt.call(is_array_buffer_x_esm_res.value, is_array_buffer_x_esm_descriptor.get);
