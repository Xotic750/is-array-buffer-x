 ...
 */
"use strict";var toStringTag,aBufTag,attempt=_dereq_("attempt-x"),isObjectLike=_dereq_("is-object-like-x"),getOwnPropertyDescriptor=_dereq_("object-get-own-property-descriptor-x"),hasABuf="function"==typeof ArrayBuffer,bLength=!1;if(hasABuf){if(_dereq_("has-to-string-tag-x")){var descriptor=getOwnPropertyDescriptor(ArrayBuffer.prototype,"byteLength");if(descriptor&&"function"==typeof descriptor.get){var res=attempt(function(){return new ArrayBuffer(4)});!1===res.threw&&isObjectLike(res.value)&&(res=attempt.call(res.value,descriptor.get),bLength=!1===res.threw&&"number"==typeof res.value&&descriptor.get)}}!1===bLength&&(toStringTag=_dereq_("to-string-tag-x"),aBufTag="[object ArrayBuffer]")}module.exports=function isArrayBuffer(object){if(!1===hasABuf||!1===isObjectLike(object))return!1;if(!1===bLength)return toStringTag(object)===aBufTag;var result=attempt.call(object,bLength);return!1===result.threw&&"number"==typeof result.value}},{"attempt-x":3,"has-to-string-tag-x":7,"is-object-like-x":15,"object-get-own-property-descriptor-x":24,"to-string-tag-x":36}],2:[function(_dereq_,module,exports){/**
